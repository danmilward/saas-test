	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/(marketing)/auth/callback/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/(marketing)/blog/rss.xml/_server.ts.js'))
			},
			{
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/(marketing)/search/api.json/_server.ts.js'))
			}
		],
		matchers: async () => {
