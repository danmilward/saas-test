...
function generatePaths(excludeRoutePatterns = [], paramValues = {}, lang = { alternates: [], default: "" }) {
  const svelteRoutes = Object.keys({ "/src/routes/(admin)/account/(menu)/+page.svelte": 0, "/src/routes/(admin)/account/(menu)/billing/+page.svelte": 0, "/src/routes/(admin)/account/(menu)/settings/+page.svelte": 0, "/src/routes/(admin)/account/(menu)/settings/change_email/+page.svelte": 0, "/src/routes/(admin)/account/(menu)/settings/change_email_subscription/+page.svelte": 0, "/src/routes/(admin)/account/(menu)/settings/change_password/+page.svelte": 0, "/src/routes/(admin)/account/(menu)/settings/delete_account/+page.svelte": 0, "/src/routes/(admin)/account/(menu)/settings/edit_profile/+page.svelte": 0, "/src/routes/(admin)/account/(menu)/settings/reset_password/+page.svelte": 0, "/src/routes/(admin)/account/create_profile/+page.svelte": 0, "/src/routes/(admin)/account/select_plan/+page.svelte": 0, "/src/routes/(admin)/account/sign_out/+page.svelte": 0, "/src/routes/(marketing)/+page.svelte": 0, "/src/routes/(marketing)/blog/(posts)/awesome_post/+page.svelte": 0, "/src/routes/(marketing)/blog/(posts)/example_blog_post/+page.svelte": 0, "/src/routes/(marketing)/blog/(posts)/how_we_built_our_41kb_saas_website/+page.svelte": 0, "/src/routes/(marketing)/blog/+page.svelte": 0, "/src/routes/(marketing)/contact_us/+page.svelte": 0, "/src/routes/(marketing)/login/+page.svelte": 0, "/src/routes/(marketing)/login/current_password_error/+page.svelte": 0, "/src/routes/(marketing)/login/forgot_password/+page.svelte": 0, "/src/routes/(marketing)/login/sign_in/+page.svelte": 0, "/src/routes/(marketing)/login/sign_up/+page.svelte": 0, "/src/routes/(marketing)/pricing/+page.svelte": 0, "/src/routes/(marketing)/search/+page.svelte": 0 });
